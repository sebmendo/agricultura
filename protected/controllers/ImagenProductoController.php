...
class ImagenProductoController extends Controller
{
	...
	*/
	public function actionCreate()
	{
		...
		if(isset($_POST['ImagenProducto']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->id_imagen_producto));
		}
	...
	*/
	...
	{
		$dataProvider=new CActiveDataProvider('ImagenProducto');
	...
	*/
	...
	{
		$model=new ImagenProducto('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ImagenProducto']))
			$model->attributes=$_GET['ImagenProducto'];
	...
	* @return ImagenProducto the loaded model
	...
	* @param ImagenProducto $model the model to be validated
	*/
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='imagen-producto-form')
		{
