...
<script>
    ...
    function listarProductos() {
        ...
        if (nombreProducto == '') {
            $.ajax({
                url: '<?php echo Yii::app()->baseUrl . '/index.php?r=producto/vacio' ?>',
                type: 'post',
            ...
            $.ajax({
                url: '<?php echo Yii::app()->baseUrl . '/index.php?r=producto/busqueda' ?>',
                type: 'post',
                data: {nombre: nombreProducto},
                success: function (data) {
                    var datos = data.split("/");
                    ...
                    for (i = 0; i < datos.length - 1; i = i + 7) {
                        if (datos[i] != null) {
                            ...
                            $("#content").append('No hay Resultados');
                        }
                    }
...
<div class="producto-index">
    ...
    <?php if (Yii::app()->user->hasFlash('success')): ?>
        <div class="info">
            ...
            <?php
            echo BsHtml::alert(BsHtml::ALERT_COLOR_SUCCESS, BsHtml::bold('Bien hecho!  ') . 'El producto se ha agregado exitosamente a su carro de compras', array('style' => 'padding-right: 35px;'));
            ?>
    ...
    <?php if (Yii::app()->user->hasFlash('error')): ?>
        <div class="info">
            ...
            <?php
            echo BsHtml::alert(BsHtml::ALERT_COLOR_ERROR, BsHtml::bold('Error!  ') . 'El carro debe tener productos', array('style' => 'padding-right: 35px;'));
            ?>
    ...
    <div class="row" style="padding: 20px;">
            ...
            <div id="custom-search-input" style="width: 70%;">
                <div class="input-group col-md-4">
                    <input id="busquedaProducto" style="height: 34px;" type="text" class="  search-query form-control" placeholder="Buscar por Nombre" onkeyup="listarProductos()" />
