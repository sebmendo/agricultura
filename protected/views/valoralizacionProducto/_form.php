...
<?php $form=$this->beginWidget('bootstrap.widgets.BsActiveForm', array(
    'id'=>'valoralizacion-producto-form',
...
<input name="ValoralizacionProducto[valoralizacion]" id="ValoralizacionProducto_valoralizacion"  data-show-clear="false" class="rating rating-loading" data-min="0" data-max="5" data-step="0.5">
<?php echo $form->textAreaControlGroup($model, 'comentario'); ?>
    <?php echo BsHtml::submitButton('Calificar', array('color' => BsHtml::BUTTON_COLOR_PRIMARY)); ?>
