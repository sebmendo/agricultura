 ...
 * @property integer $id_imagen_producto
...
class ImagenProducto extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nombre_imagen, id_producto', 'required'),
			array('id_producto', 'numerical', 'integerOnly'=>true),
			array('nombre_imagen', 'length', 'max'=>500),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_imagen_producto, nombre_imagen, id_producto', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'id_imagen_producto' => 'Id Imagen Producto',
	...
	public function search()
	{
		...
		$criteria->compare('id_imagen_producto',$this->id_imagen_producto);
